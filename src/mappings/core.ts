...
export function handleTransfer(event: Transfer): void {
  ...
  let factory = CCSwapFactory.load(FACTORY_ADDRESS)
...
export function handleSwap(event: Swap): void {
  ...
  CCSwapDayData.dailyVolumeUSD = CCSwapDayData.dailyVolumeUSD.plus(trackedAmountUSD)
  CCSwapDayData.dailyVolumeETH = CCSwapDayData.dailyVolumeETH.plus(trackedAmountETH)
  CCSwapDayData.dailyVolumeUntracked = CCSwapDayData.dailyVolumeUntracked.plus(derivedAmountUSD)
  CCSwapDayData.save()
